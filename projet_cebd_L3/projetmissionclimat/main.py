...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        ttk.Button(self, text='F3 : températures par département et par année (à optimiser)',
        ...
        ttk.Button(self, text='Q1 : départements de la zone climatique H1',
                   command=self.open_Q1_window).grid(columnspan=3, pady=5)
        ttk.Button(self, text='Q2 : département le plus chaud par zone climatique',
                   command=self.open_Q2_window).grid(columnspan=3, pady=5)
        ttk.Button(self, text='Q3 : nombre de mesures prises et moyenne des temperatures [...] (version dynamique)',
        ...
        ttk.Button(self, text='Q6 : Records de températures historiques pour la zone H1 en 2018',
                   command=self.open_Q6_window).grid(columnspan=3, pady=5)
        ttk.Button(self, text='Q7 : gérer les travaux de rénovation',
